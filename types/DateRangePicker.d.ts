...
export default class DateRangePicker {
     ...
     */
    constructor(element: HTMLElement, options?: import("./types.js").DateRangePickerOptions);
    element: HTMLElement;
    inputs: HTMLElement[];
     ...
     */
    setOptions(options: import("./types.js").DateRangePickerOptions): void;
    /**
     ...
     */
    setDates(rangeStart: import("./types.js").DateLike | {
        clear: true;
    }, rangeEnd: import("./types.js").DateLike | {
        clear: true;
    }, options?: import("./types.js").DatepickerSetDateOptions): void;
    _updating: boolean;
}
