...
- **Time picker** — opt-in via `pickTime: true`, with optional `minuteStep`. Renders 24-hour hour/minute controls (number input + range slider) below the calendar; selected dates retain their hour and minute.
