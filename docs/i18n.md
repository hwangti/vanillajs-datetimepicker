...
import es from 'path/to/node_modules/@hwangti/vanillajs-datetimepicker/js/i18n/locales/es.js';
import fr from 'path/to/node_modules/@hwangti/vanillajs-datetimepicker/js/i18n/locales/fr.js';
import zhCN from 'path/to/node_modules/@hwangti/vanillajs-datetimepicker/js/i18n/locales/zh-CN.js';
...
import es from '@hwangti/vanillajs-datetimepicker/locales/es';
import fr from '@hwangti/vanillajs-datetimepicker/locales/fr';
import zhCN from '@hwangti/vanillajs-datetimepicker/locales/zh-CN';
...
<script src="https://cdn.jsdelivr.net/npm/@hwangti/vanillajs-datetimepicker/dist/js/locales/es.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@hwangti/vanillajs-datetimepicker/dist/js/locales/fr.js"></script>
<script src="https://cdn.jsdelivr.net/npm/@hwangti/vanillajs-datetimepicker/dist/js/locales/zh-CN.js"></script>
```
